...
class Competitions extends HTTPClient
{
     ...
     * @throws Exception
     */
    public function getMapPool($competitionId)
    {
        if (!$competitionId) {
    ...
    public function getInvitationKey($competitionId, $offset = 0, $length = 20)
    {
        if (!$competitionId) {
            throw new Exception('Invalid competitionId');
        }
    ...
    public function inviteTeam($competitionId, $teamId)
    {
        if (!$competitionId) {
            throw new Exception('Invalid competitionId');
        }
     ...
     * @throws Exception
     */
    public function removeTeam($competitionId, $teamId)
    {
        if (!$competitionId) {
            throw new Exception('Invalid competitionId');
        }
     ...
     * @throws Exception
     */
    public function create($name, $titleIdString, $isLan, $registrationMode = self::REGISTRATION_MODE_OPEN)
    {
        if (!$name) {
     ...
     * @throws Exception
     */
    public function update($id, $name, $titleIdString, $isLan, $registrationMode = self::REGISTRATION_MODE_OPEN,
     ...
     */
    public function registerResults($competitionId, array $results)
    {
        if (!$competitionId) {
            throw new Exception;
        }
