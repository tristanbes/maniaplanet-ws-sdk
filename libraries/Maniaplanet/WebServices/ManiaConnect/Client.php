...
abstract class Client extends \Maniaplanet\WebServices\HTTPClient
{
     ...
     */
    protected static $persistance;

    public static function setPersistance(Persistance $object)
    {
        if (self::$persistance) {
     ...
     */
    public function getLoginURL($scope = null, $redirectURI = null)
    {
    ...
    protected function getAccessToken()
    {
        ...
        } elseif ($token !== null && $token->refresh_token !== null) {
