...
class TrustCircles extends HTTPClient
{
     ...
     * @throws Exception
     */
    public function getKarma($circle, $player)
    {
        if (!$circle) {
     ...
     */
    public function getBlackList($circle = null)
    {
        if ($circle) {
     ...
     */
    public function getWhiteList($circle = null)
    {
        if ($circle) {
     ...
     * @throws Exception
     */
    public function blackList($player)
    {
        if (!$player) {
            throw new Exception('Invalid player');
        }
     ...
     * @throws Exception
     */
    public function whiteList($player)
    {
        if (!$player) {
            throw new Exception('Invalid player');
        }
     ...
     * @throws Exception
     */
    public function unBlackList($player)
    {
        if (!$player) {
            throw new Exception('Invalid player');
        }
     ...
     * @throws Exception
     */
    public function unWhiteList($player)
    {
        if (!$player) {
            throw new Exception('Invalid player');
        }
