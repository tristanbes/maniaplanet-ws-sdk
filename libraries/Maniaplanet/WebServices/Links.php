...
class Links extends HTTPClient
{
    ...
    public function createForTeam($teamId, $link, $name, $category, $isFeatured = false)
    {
        $obj = array(
            'link' => $link,
            'name' => ($name ? : $link),
    ...
    public function createForCompetition($competitionId, $link, $name, $category, $isFeatured = false)
    {
        $obj = array(
            'link' => $link,
            'name' => ($name ? : $link),
