...
class ManiaHome
{
     ...
     * @deprecated since version 3.1.0
     */
    public function postNotification(Notification $n)
    {
        if ($n->receiverName) {
            if ($n->isPrivate) {
     ...
     * @deprecated since version 3.1.0
     */
    public function postPublicNotification(Notification $n)
    {
        return $this->manialinkPublisher->postPublicNotification($n->message, $n->link, $n->iconStyle, $n->iconSubStyle);
    }
     ...
     * @deprecated since version 3.1.0
     */
    public function postPersonalNotification(Notification $n)
    {
     ...
     * @deprecated since version 3.1.0
     */
    public function postPrivateNotification(Notification $n)
    {
     ...
     * @deprecated since version 3.1.0
     */
    public function postPrivateEvent(Event $e)
    {
     ...
     * @deprecated since version 3.1.0
     */
    public function postPublicEvent(Event $e)
    {
     ...
     * @deprecated since version 3.1.0
     */
    public function getCommentsCount($notificationId)
    {
